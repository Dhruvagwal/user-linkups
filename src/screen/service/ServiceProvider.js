            ...
            <BottomSheet snapPoints={[HEIGHT*.245, HEIGHT*.85]}>
                <View style={{backgroundColor:color.elevatedDark,width:WIDTH,borderTopRightRadius:30, borderTopLeftRadius:30}}>
                    <ScrollView style={{marginTop:10}}>
                        <Image source={{uri}} style={{height:AVATAR_SIZE, width:AVATAR_SIZE, borderRadius:AVATAR_SIZE, zIndex: 100,alignSelf:'center'}}/>
                        <View style={{alignSelf:'center', alignItems:'center'}}>
                            <Text size={25} style={{ textAlign:'center', width:WIDTH*0.9}} bold numberOfLines={2} adjustsFontSizeToFit>Dhruv Aggarwal</Text>
